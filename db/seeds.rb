...
e11 = Event.create!(user_id: jojo.id, event_name: "Black Rose - Chapter 6", venue_name: "Amazura", zip: "11435", state: "NY", img_url: "https://flowerlinkla.com/wp-content/uploads/2013/10/black-rose-dektop-hd.png", city: "Jamaica", address: "91-12 144th PL", event_category_id: nightlife.id, date: "2022/02/20", description: "Nap gen emposib, nap gen klass. It's gonna be Lit!")
...
e12 = Event.create!(user_id: jojo.id, event_name: "La Nuit Des Jeunes", venue_name: "Amazura", zip: "11435", state: "NY", img_url: "https://img.freepik.com/free-photo/nightlife-with-people-dancing-club_23-2149052717.jpg", city: "Jamaica", address: "91-12 144th PL", event_category_id: nightlife.id, date: "2022/03/26", description: "Bèl bagay nèt. The setting is just beautiful. come with friends. You will enjoy it guarentee.")
...
e13 = Event.create!(user_id: jojo.id, event_name: "Kick Off Party", venue_name: "Bentley's", zip: "11234", state: "NY", img_url: "https://i.pinimg.com/736x/30/cd/05/30cd05f7c7502e9f6d3792a17c4d624b--jamberry-party-jamberry-nails.jpg", city: "Brooklyn", address: "1370 Ralph ave", event_category_id: concert.id, date: "2022/03/25", description: "We have a lot of space for a lot of people. Come and chill and enjoy the good drinks we'll be having.")
...
e14 = Event.create!(user_id: jojo.id, event_name: "Lovers Rock | Red & Black Affair", venue_name: "Bentley's", zip: "11234", state: "NY", img_url: "https://m.media-amazon.com/images/M/MV5BYjNlYTAwNzktYzdkMS00NzhlLWE4NjEtYzZjMzY1MWI3ZDQwXkEyXkFqcGdeQXVyODk4OTc3MTY@._V1_.jpg", city: "Brooklyn", address: "1370 Ralph ave", event_category_id: concert.id, date: "2022/02/11", description:"Come in black and come in red. Nou gen Harmonick, nou gen Kai. DJ Stackz ap la, it's gonna be a movie!")
