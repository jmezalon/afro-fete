...
christian = Hashtag.create(tag: 'christian') 
...
e5 = Event.create!(user_id: jojo.id, event_name: "", venue_name: "Brooklyn Party Space", zip: "11226", state: "NY", img_url: "https://spacehuntr.com/wp-content/uploads/2021/04/Oriental-Inspired-Venue-with-a-Mysterious-Vibe-via-Spacehuntr.jpg", city: "Brooklyn", address: "1463 E 96th", event_category_id: afterwork.id, date: "2022/02/01", description: "what are you doing tonight? checkout this scenary. you know you want to come. don't think about it too much. call your significant other and come enjoy!", link_to_purchase: "")
...
e8 = Event.create!(user_id: jojo.id, event_name: "", venue_name: "Lux pleasure", zip: "10736", state: "NY", img_url: "https://pyxis.nymag.com/v1/imgs/101/30b/f06555b200ed1e823d4d2241e5788a3160-2----.w710.jpg", city: "Staten Island", address: "56-21 staten island dr", event_category_id: nightlife.id, date: "2022/03/11", description: "this is outdoor and it's spacious. come in full it will be very lovely.", link_to_purchase: "")
